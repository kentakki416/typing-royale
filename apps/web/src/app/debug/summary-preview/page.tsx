 ...
 * mypage は認証必須で preview では sign-in に飛ぶため、サマリーのヘッダー（GitHub アバター画像）
 * + 新 stat 行（ベストスコア / 得意なリポジトリ / 平均正確率）+ 苦手文字 top10 を mock で render する。
    ...
    <div className="container">
      <div className="flex gap-16 mb-24" style={{ alignItems: "center" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <span className="badge-grade senior" data-level={4}>Senior Engineer</span>
        </div>
      </div>
