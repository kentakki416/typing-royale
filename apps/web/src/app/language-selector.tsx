 ...
 * 言語選択グリッド + プレイ開始ボタン
 *
 * カードを中央寄せのグリッドで並べる。1 行あたりの列数は {@link columnsFor} で決め、
 * グリッド幅を「列数 × カード幅」ぴったりに固定する（96vw でキャップしない）。
 * これにより 3 言語までは必ず横一列、4 言語で 2+2 に折り返る。狭い画面では横には
 * み出すが、一列表示を優先する（はみ出し許容）。
