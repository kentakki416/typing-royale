...
combo の伸びに応じて、以下の 2 軸で「明るく・高く」変化する。

| combo | クリックの中心周波数 | ピッチアクセントの音域 |
|------:|---------------------:|----------------------:|
|  0〜4  | 2400Hz               | C5〜A5（基準）        |
|  5〜14 | 2800Hz               | C5〜A5                |
| 15〜29 | 3200Hz               | C6〜A6（+1 oct）      |
|  30〜  | 3200Hz               | C7〜A7（+2 oct）      |

combo が切れる（miss する）と即基準に戻る。「combo を切らさず伸ばすほど音が明るく・高くなる」体験になる。

> **メモ**: combo banner の UI 仕様（10 combo ごとに色変化・常時表示）と、combo に応じてさらに音色を変える拡張は、別 PR (combo-tier-display) で追加予定。
